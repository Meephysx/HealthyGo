    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50 flex items-center justify-center p-4">
      <div className="max-w-2xl w-full bg-white rounded-2xl shadow-xl overflow-hidden relative">
        ...
        <img
          ...
          style={{ top: "50%", left: "50%", transform: "translate(-50%, -50%)", filter: "blur(1px)" }}
        />
        ...
        <div className="p-8 relative z-10">
              ...
              <div>
                ...
                <div className="space-y-3">
                  {ACTIVITY_LEVELS.map((level) => (
                    <label key={level.value} className="flex items-center p-4 border rounded-lg cursor-pointer">
                      <input
                        type="radio"
                        name="activityLevel"
                        value={level.value}
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  {[
                    ...
                    <label key={goal.value} className="flex flex-col items-center p-6 border rounded-xl cursor-pointer">
                      <input
                        type="radio"
                        name="goal"
                        value={goal.value}
          ...
          {currentStep === 4 && (
            <div className="space-y-6">
              ...
              <div>
                <label className="block font-medium mb-3">Dietary Restrictions</label>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                  {DIETARY_RESTRICTIONS.map((restriction) => (
                    <label key={restriction} className="flex items-center p-3 border rounded-lg cursor-pointer">
                      <input
                        type="checkbox"
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
                  {COMMON_ALLERGIES.map((allergy) => (
                    <label key={allergy} className="flex items-center p-3 border rounded-lg cursor-pointer">
                      <input
                        type="checkbox"
